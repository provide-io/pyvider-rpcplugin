...
async def test_create_grpc_channel_with_mtls(client_instance):
    ...
    # Mock rpcplugin_config to simulate explicit client cert configuration
    with patch("pyvider.rpcplugin.client.base.rpcplugin_config") as mock_config:
        mock_config.get.side_effect = lambda key, default=None: (
            "dummy_client_cert_path_in_config"
