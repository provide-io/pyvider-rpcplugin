...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("192.168.1.100:443", True),
            ...
            ("[::1]:8000", False), # IPv6 with brackets - Expected False with current simple split logic
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("localhost: 65530", False), # Port with space (current logic would make it False due to split)
        ("localhost:65536", True), # Invalid port number, but function only checks isdigit
