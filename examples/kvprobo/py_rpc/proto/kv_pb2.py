...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'Z>github.com/provide-io/pyvider-rpcplugin/examples/kvprobo/proto'
