...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMessageHistory = channel.unary_unary(
                ...
                request_serializer=chat__pb2.MessageHistoryRequest.SerializeToString,
                response_deserializer=chat__pb2.MessageHistoryResponse.FromString,
                _registered_method=True)
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMessageHistory': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=chat__pb2.MessageHistoryRequest.FromString,
                    response_serializer=chat__pb2.MessageHistoryResponse.SerializeToString,
            ),
...
class ChatService(object):
    ...
    def GetMessageHistory(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/chat.ChatService/GetMessageHistory',
            chat__pb2.MessageHistoryRequest.SerializeToString,
            chat__pb2.MessageHistoryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
