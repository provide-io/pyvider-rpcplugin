...
!!! note "Using gRPC Stubs" The client provides a `grpc_channel` for making RPC calls. You must use generated gRPC stubs - the client doesn't provide automatic service proxies.
