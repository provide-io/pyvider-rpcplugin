...
# is generally preferred. See `05_security_mtls.py` for a detailed example. and the main `examples/README.md` for more detailed examples of mTLS setup, including client-side configuration and using certificate content environment variables.
