...
Traceback (most recent call last):
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/server.py", line 258, in _negotiate_handshake
    validate_magic_cookie()
    ~~~~~~~~~~~~~~~~~~~~~^^
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/handshake.py", line 204, in validate_magic_cookie
...
Traceback (most recent call last):
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/examples/kv/py_kv_server.py", line 188, in <module>
    asyncio.run(serve())
    ~~~~~~~~~~~^^^^^^^^^
  ...
  File "/opt/homebrew/Cellar/python@3.13/3.13.2/Frameworks/Python.framework/Versions/3.13/lib/python3.13/asyncio/base_events.py", line 725, in run_until_complete
    return future.result()
           ~~~~~~~~~~~~~^^
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/examples/kv/py_kv_server.py", line 168, in serve
    await server.serve()
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/server.py", line 308, in serve
    await self._negotiate_handshake()
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/server.py", line 281, in _negotiate_handshake
...
Traceback (most recent call last):
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/client/base.py", line 218, in _read_handshake_response
  ...
  File "/opt/homebrew/Cellar/python@3.13/3.13.2/Frameworks/Python.framework/Versions/3.13/lib/python3.13/asyncio/tasks.py", line 507, in wait_for
    return await fut
           ^^^^^^^^^
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/client/base.py", line 209, in read_stdout
...
Traceback (most recent call last):
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/examples/kv/./py_kv_client.py", line 136, in main
    await client.connect()
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/examples/kv/./py_kv_client.py", line 55, in connect
    await self._client.start()
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/client/base.py", line 397, in start
    await self._perform_handshake()
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/client/base.py", line 94, in _perform_handshake
    response_str = await self._read_handshake_response()
                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/client/base.py", line 238, in _read_handshake_response
...
Traceback (most recent call last):
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/examples/kv/./py_kv_client.py", line 152, in <module>
    asyncio.run(main())
    ~~~~~~~~~~~^^^^^^^^
  File "/opt/homebrew/Cellar/python@3.13/3.13.2/Frameworks/Python.framework/Versions/3.13/lib/python3.13/asyncio/runners.py", line 195, in run
    return runner.run(main)
  ...
  File "/opt/homebrew/Cellar/python@3.13/3.13.2/Frameworks/Python.framework/Versions/3.13/lib/python3.13/asyncio/base_events.py", line 725, in run_until_complete
    return future.result()
           ~~~~~~~~~~~~~^^
  File "/Users/tim.perkins/code/tf/pyvider/src/pyvider/rpcplugin/examples/kv/./py_kv_client.py", line 147, in main
    raise Exception
Exception
