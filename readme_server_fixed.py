...
async def main():
    # For this simple example, run insecurely without mTLS
    # In production, mTLS is recommended (see security examples)
...
if __name__ == "__main__":
    try:
        ...
        # Added cleanup for test robustness, though not in README
        import os
