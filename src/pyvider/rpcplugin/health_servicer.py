...
class HealthServicer(health_pb2_grpc.HealthServicer):
    ...
    def __init__(self, app_is_healthy_callable: Callable[[], bool], service_name: str = ""):
        """
        Args:
    ...
    async def Watch(self, request: health_pb2.HealthCheckRequest, context: grpc.aio.ServicerContext):
        """
