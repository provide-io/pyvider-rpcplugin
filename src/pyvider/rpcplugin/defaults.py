...
# =================================
# Telemetry Configuration Defaults (OpenTelemetry)
# =================================
DEFAULT_PLUGIN_TELEMETRY_ENABLED = False
DEFAULT_PLUGIN_TELEMETRY_SERVICE_NAME = "pyvider.rpcplugin"
DEFAULT_PLUGIN_TELEMETRY_SERVICE_VERSION = None
DEFAULT_PLUGIN_OTEL_TRACES_ENABLED = False
DEFAULT_PLUGIN_OTEL_METRICS_ENABLED = False
DEFAULT_PLUGIN_OTEL_ENDPOINT = None
DEFAULT_PLUGIN_OTEL_TRACES_ENDPOINT = None
DEFAULT_PLUGIN_OTEL_METRICS_ENDPOINT = None
DEFAULT_PLUGIN_OTEL_PROTOCOL = "grpc"  # "grpc" or "http"
DEFAULT_PLUGIN_OTEL_HEADERS = None
DEFAULT_PLUGIN_TRACE_SAMPLE_RATE = 1.0
