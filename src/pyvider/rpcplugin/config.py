...
class RPCPluginConfigKeys:
    """
    Frozen configuration containing all RPC plugin environment variable keys.
    
    This provides a single source of truth for all config keys, replacing
    hardcoded constants and enabling clean test isolation.
    """
    PLUGIN_CORE_VERSION: str = "PLUGIN_CORE_VERSION"
    PLUGIN_LOG_LEVEL: str = "PLUGIN_LOG_LEVEL"
    PLUGIN_MAGIC_COOKIE_KEY: str = "PLUGIN_MAGIC_COOKIE_KEY"
    PLUGIN_MAGIC_COOKIE_VALUE: str = "PLUGIN_MAGIC_COOKIE_VALUE"
    PLUGIN_PROTOCOL_VERSIONS: str = "PLUGIN_PROTOCOL_VERSIONS"
    PLUGIN_SERVER_TRANSPORTS: str = "PLUGIN_SERVER_TRANSPORTS"
    PLUGIN_SERVER_ENDPOINT: str = "PLUGIN_SERVER_ENDPOINT"
    PLUGIN_AUTO_MTLS: str = "PLUGIN_AUTO_MTLS"
    PLUGIN_SERVER_CERT: str = "PLUGIN_SERVER_CERT"
    PLUGIN_SERVER_KEY: str = "PLUGIN_SERVER_KEY"
    PLUGIN_SERVER_ROOT_CERTS: str = "PLUGIN_SERVER_ROOT_CERTS"
    PLUGIN_CLIENT_TRANSPORTS: str = "PLUGIN_CLIENT_TRANSPORTS"
    PLUGIN_CLIENT_ENDPOINT: str = "PLUGIN_CLIENT_ENDPOINT"
    PLUGIN_CLIENT_CERT: str = "PLUGIN_CLIENT_CERT"
    PLUGIN_CLIENT_KEY: str = "PLUGIN_CLIENT_KEY"
    PLUGIN_CLIENT_ROOT_CERTS: str = "PLUGIN_CLIENT_ROOT_CERTS"
    PLUGIN_HANDSHAKE_TIMEOUT: str = "PLUGIN_HANDSHAKE_TIMEOUT"
    PLUGIN_CONNECTION_TIMEOUT: str = "PLUGIN_CONNECTION_TIMEOUT"
    PLUGIN_SHOW_EMOJI_MATRIX: str = "PLUGIN_SHOW_EMOJI_MATRIX"
    PLUGIN_CLIENT_RETRY_ENABLED: str = "PLUGIN_CLIENT_RETRY_ENABLED"
    PLUGIN_CLIENT_MAX_RETRIES: str = "PLUGIN_CLIENT_MAX_RETRIES"
    PLUGIN_CLIENT_INITIAL_BACKOFF_MS: str = "PLUGIN_CLIENT_INITIAL_BACKOFF_MS"
    PLUGIN_CLIENT_MAX_BACKOFF_MS: str = "PLUGIN_CLIENT_MAX_BACKOFF_MS"
    PLUGIN_CLIENT_RETRY_JITTER_MS: str = "PLUGIN_CLIENT_RETRY_JITTER_MS"
    PLUGIN_CLIENT_RETRY_TOTAL_TIMEOUT_S: str = "PLUGIN_CLIENT_RETRY_TOTAL_TIMEOUT_S"
    PLUGIN_SHUTDOWN_FILE_PATH: str = "PLUGIN_SHUTDOWN_FILE_PATH"
    PLUGIN_RATE_LIMIT_ENABLED: str = "PLUGIN_RATE_LIMIT_ENABLED"
    PLUGIN_RATE_LIMIT_REQUESTS_PER_SECOND: str = "PLUGIN_RATE_LIMIT_REQUESTS_PER_SECOND"
    PLUGIN_RATE_LIMIT_BURST_CAPACITY: str = "PLUGIN_RATE_LIMIT_BURST_CAPACITY"
    PLUGIN_HEALTH_SERVICE_ENABLED: str = "PLUGIN_HEALTH_SERVICE_ENABLED"
    
    def all_keys(self) -> list[str]:
        """Get all environment variable keys as a list."""
        return [
            self.PLUGIN_CORE_VERSION,
            self.PLUGIN_LOG_LEVEL,
            self.PLUGIN_MAGIC_COOKIE_KEY,
            self.PLUGIN_MAGIC_COOKIE_VALUE,
            self.PLUGIN_PROTOCOL_VERSIONS,
            self.PLUGIN_SERVER_TRANSPORTS,
            self.PLUGIN_SERVER_ENDPOINT,
            self.PLUGIN_AUTO_MTLS,
            self.PLUGIN_SERVER_CERT,
            self.PLUGIN_SERVER_KEY,
            self.PLUGIN_SERVER_ROOT_CERTS,
            self.PLUGIN_CLIENT_TRANSPORTS,
            self.PLUGIN_CLIENT_ENDPOINT,
            self.PLUGIN_CLIENT_CERT,
            self.PLUGIN_CLIENT_KEY,
            self.PLUGIN_CLIENT_ROOT_CERTS,
            self.PLUGIN_HANDSHAKE_TIMEOUT,
            self.PLUGIN_CONNECTION_TIMEOUT,
            self.PLUGIN_SHOW_EMOJI_MATRIX,
            self.PLUGIN_CLIENT_RETRY_ENABLED,
            self.PLUGIN_CLIENT_MAX_RETRIES,
            self.PLUGIN_CLIENT_INITIAL_BACKOFF_MS,
            self.PLUGIN_CLIENT_MAX_BACKOFF_MS,
            self.PLUGIN_CLIENT_RETRY_JITTER_MS,
            self.PLUGIN_CLIENT_RETRY_TOTAL_TIMEOUT_S,
            self.PLUGIN_SHUTDOWN_FILE_PATH,
            self.PLUGIN_RATE_LIMIT_ENABLED,
            self.PLUGIN_RATE_LIMIT_REQUESTS_PER_SECOND,
            self.PLUGIN_RATE_LIMIT_BURST_CAPACITY,
            self.PLUGIN_HEALTH_SERVICE_ENABLED,
        ]


# Global frozen config keys instance
CONFIG_KEYS = RPCPluginConfigKeys()
